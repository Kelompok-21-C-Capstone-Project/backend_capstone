...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.DashboardDetailTransactionDTO"
                            }
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "dto.DashboardDetailTransactionDTO": {
            "type": "object",
            "properties": {
                "summary": {
                    "$ref": "#/definitions/dto.DetailPenjualanDTO"
                },
                "transaksi": {
        ...
        "dto.DataTransactionDTO": {
            "type": "object",
            "properties": {
                "datas": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.DetailTransactionDTO"
                    }
                },
                "page_length": {
                    "type": "integer",
